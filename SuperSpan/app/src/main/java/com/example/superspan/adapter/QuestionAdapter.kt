...
class QuestionAdapter (private val listaDomande: List<Question>) :
RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class ApertaViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(domanda : Question){
            ...
            currentTextWatcher = object : TextWatcher {
                ...
                override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                    // AGGIORNA IL MODELLO: Questo è fondamentale per non perdere i dati allo scroll
                    // Nota: In un'app reale, potresti voler aggiornare un ViewModel qui
    ...
    class MultiplaViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
